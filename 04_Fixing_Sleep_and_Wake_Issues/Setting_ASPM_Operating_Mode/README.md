...
For machines using Always-On Always-Connected technology [(**AOAC**)](/04_Fixing_Sleep_and_Wake_Issues/Fixing_AOAC_Machines), try changing the ASPM modes of PCI devices such as Wireless cards, SSDs, etc. to reduce overall power consumption.
...
- The patch principle is the same as for [Disabling PCI Devices](/02_Disabling_Devices/Disabling_PCI_Devices).
