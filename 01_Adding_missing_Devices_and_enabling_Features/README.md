...
- **需求**:
  ...
  - 热补丁的 **'_STA'** 方法必须包含 [**'If （_OSI （“Darwin”））'**]（https://uefi.org/specs/ACPI/6.4/05_ACPI_Software_Programming_Model/ACPI_Software_Programming_Model.html#osi-operating-system-interfaces） 方法或使用OpenCore Mod，以确保补丁仅适用于 macOS （Darwin Kernel）：
	...
	```
- **示例**: [**修复IRQ冲突**](https://github.com/laobamac/OC-little-zh/tree/main/01_Adding_missing_Devices_and_enabling_Features/IRQ_and_Timer_Fix_(SSDT-HPET))
...
> [!NOTE]
> 
> 您可以使用 Python 脚本 [**SSDTTime**]（https://github.com/laobamac/OC-little-zh/tree/main/01_Adding_missing_Devices_and_enabling_Features/_SSDTTime） 自动生成大量相关的 SSDT 修补程序。
