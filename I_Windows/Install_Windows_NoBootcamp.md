...
4. The following Windows should be displayed:<br> ![Win10Config](https://github.com/laobamac/OC-little-zh/assets/76865553/b633cf25-ee19-4581-887c-42173a232a8f)
...
10. Reboot
11. Windows should now be available from the Bootpicker. If it's not, open your `config.plist`. Add `\EFI\Microsoft\Boot\bootmgfw.efi` to `Misc/BlessOverride`:<br>![Bless](https://github.com/laobamac/OC-little-zh/assets/76865553/fdb65892-ccea-4e7d-90f4-c60742a0124a)
12. Save and Reboot
