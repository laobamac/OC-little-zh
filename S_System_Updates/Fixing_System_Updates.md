...
2. When adding flag(s) "Allow Apple Internal" and/or "Allow Unauthenticated Root" to the `csr-active-config` value in macOS Big Sur and newer (&rarr; see chapter "[OpenCore Calculators](/B_OC_Calculators)" for details)
...
## Notes
- [**Reducing the download size of OTA Updates**](/S_System_Updates/OTA_Updates.md)
