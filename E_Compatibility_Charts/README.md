...
[**AMD GPU Compatibility Chart**](/11_Graphics/GPU/AMD_GPU_Compatbility.md) (md)|
...
- Make use of macOS 11.3+ virtualization capabilities to spoof a supported SMBIOS but let the hardware use the intended SMBIOS for your CPU! Check my [**Boad-ID VMM spoofing**](/09_Board-ID_VMM-Spoof) guide to find out how it works.
